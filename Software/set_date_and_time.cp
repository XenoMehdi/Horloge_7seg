#line 1 "J:/Dropbox/Dropbox/F.E.S Industries/Projets Ouadie/Hor_Temp_7Seg/Software/set_date_and_time.c"
...
#line 3 "J:/Dropbox/Dropbox/F.E.S Industries/Projets Ouadie/Hor_Temp_7Seg/Software/set_date_and_time.c"
...
I2C1_Wr(0);
I2C1_Wr( ((clock_set.digit_2 & 0x0F) << 4) | (clock_set.digit_1 & 0x0F) );
I2C1_Wr( ((clock_set.digit_4 & 0x0F) << 4) | (clock_set.digit_3 & 0x0F) );
I2C1_Wr( ((calendar_set.digit_4 & 0x0F) << 4) | (calendar_set.digit_3 & 0x0F) );
I2C1_Wr( ((calendar_set.digit_2 & 0x0F) << 4) | (calendar_set.digit_1 & 0x0F) );
